...
def main():
    ...
    apt_principal = st.sidebar.number_input("Loan Amount ($)", value=100, step=1000, key="apt_principal")
    apt_rate = st.sidebar.number_input("Interest Rate (%)", value=3.0, step=0.01, key="apt_rate")
    ...
    inv_rate = st.sidebar.number_input("Interest Rate (%)", value=6.4, step=0.01, key="inv_rate")
